...
LEFT OFF HERE Could easily look at 2019-2022 together for number of germs in Y1 or Y2. If Obs Year == Add_Year, then Germ_Year = 1
...
Try generalized linear mixed effects models for the simplest dataset blue_19_23.
...
Come back here and rebuild models, these are copy and pasted from above.

```{r}
# Try both species together first
m0 <- glmer(Germ.binom ~ 1 + (1|Block/plot/Corner) + (1|Obs_Year), family = binomial, data = blue_yr_trt)

m0b <- glmer(Germ.binom ~ 1 + (1|Block/plot/Corner), family = binomial, data = blue_yr_trt)

m1 <- glmer(Germ.binom ~ mean_treatment + (1|Block/plot/Corner) + (1|Obs_Year), family = binomial, data = blue_yr_trt)

m2 <- glmer(Germ.binom ~ var_treatment + (1|Block/plot/Corner) + (1|Obs_Year), family = binomial, data = blue_yr_trt)

m3 <- glmer(Germ.binom ~ Species + (1|Block/plot/Corner) + (1|Obs_Year), family = binomial, data = blue_yr_trt)

m4 <- glmer(Germ.binom ~ var_treatment + mean_treatment + (1|Block/plot/Corner) + (1|Obs_Year), family = binomial, data = blue_yr_trt)

m5 <- glmer(Germ.binom ~ var_treatment + mean_treatment + mean_treatment*var_treatment + (1|Block/plot/Corner) + (1|Obs_Year), family = binomial, data = blue_yr_trt)

m6 <- glmer(Germ.binom ~ Obs_Year + (1|Block/plot/Corner), family = binomial, data = blue_yr_trt)
