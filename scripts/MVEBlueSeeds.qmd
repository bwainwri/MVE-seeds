...
Try new models
Try a different optimizer -- didn't work
Try a fixed effects model only -- convergence failure went away
...
- first at least add total annual precipitation to each year
